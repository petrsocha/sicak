...
#ifndef PREDICTAES128FRONT_H
#define PREDICTAES128FRONT_H 
...
/**
* \class PredictAES128Front
* \ingroup BlockProcess
*
* \brief AES-128 first round S-box Hamming weight power predictions SICAK BlockProcess plugin
*
*/
class PredictAES128Front : public QObject, BlockProcess {
    
    Q_OBJECT
    Q_PLUGIN_METADATA(IID "cz.cvut.fit.Sicak.BlockProcessInterface/1.0" FILE "predictaes128front.json")
    Q_INTERFACES(BlockProcess)
                
public:
    
    PredictAES128Front();
    virtual ~PredictAES128Front() override;
