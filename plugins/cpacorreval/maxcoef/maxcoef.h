...
* \ingroup CpaCorrEval
*
* \brief CPA correlation matrix evaluation SICAK CpaCorrEval plugin, looking for maximum value of coefficient
*
*/
class MaxCoef : public QObject, CpaCorrEval {
    
    Q_OBJECT
    Q_PLUGIN_METADATA(IID "cz.cvut.fit.Sicak.CpaCorrEvalInterface/1.0" FILE "maxcoef.json")
    Q_INTERFACES(CpaCorrEval)
                
public:
    
    MaxCoef();
    virtual ~MaxCoef() override;
