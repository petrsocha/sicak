...
* \ingroup CpaCorrEval
* 
* \brief CPA correlation matrix evaluation SICAK CpaCorrEval plugin, looking for maximum absolute value of coefficient
*
*/
class MaxAbsCoef : public QObject, CpaCorrEval {
    
    Q_OBJECT
    Q_PLUGIN_METADATA(IID "cz.cvut.fit.Sicak.CpaCorrEvalInterface/1.0" FILE "maxabscoef.json")
    Q_INTERFACES(CpaCorrEval)
                
public:
    
    MaxAbsCoef();
    virtual ~MaxAbsCoef() override;
