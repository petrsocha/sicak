...
* \file cpakeyeval.h
*
* \brief Keyguess evaluation plugin interface for use e.g. in correv
*
*
* \author Petr Socha
* \version 1.0
...
*
* \brief CPA keyguess evaluation QT plugin interface
*
*/
class CpaKeyEval {        
...
#define CpaKeyEval_iid "cz.cvut.fit.Sicak.CpaKeyEvalInterface/1.0"

Q_DECLARE_INTERFACE(CpaKeyEval, CpaKeyEval_iid)
